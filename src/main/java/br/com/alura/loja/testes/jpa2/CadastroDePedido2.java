...
//		}
		...
		List<RelatorioDeVendasVo> relatorioDeVendas = pedidoDao.relatorioDeVendas2();
	...
	private static void popularBancoDeDados() {
		...
		Produto macbook = new Produto("Macbook", "Mackbook pro retina", new BigDecimal("10000"), celulares);
